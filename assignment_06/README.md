...
- **Color scheme:**
 >  Overall the colour scheme of consists of variations of dark greens, red-pinks, and whites. 
 ...
 >  - I also used a red-pink colour with varying opacity for some of the buttons as well as text, to evoke a floral aesthetic in line with the garden theme.
 Overall in terms of the hue and saturation, I tried to keep all the colours I used warm in order to help the user feel comfortable, as though they are in a kind and friendly environment.
...
- "Love the colours. The orange-pink and green colour against light, pastel yellow background is very pleasant and soothing visually"
